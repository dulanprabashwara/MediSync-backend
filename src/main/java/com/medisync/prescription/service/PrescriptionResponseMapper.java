...
public class PrescriptionResponseMapper {
    ...
    public DoctorPrescriptionResponse toDoctorResponse(Prescription prescription) {
        ...
        return new DoctorPrescriptionResponse(prescription.getId(), prescription.getConsultationId(),
                ...
                prescription.getDoctorFeeConfirmedAt(),
                prescription.getDoctorBankAccountHolder(), prescription.getDoctorBankName(),
                prescription.getDoctorBankBranch(), prescription.getDoctorBankAccountNumber(),
                items, prescription.getIssuedAt(), prescription.getValidUntil(),
